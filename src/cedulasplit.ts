...
import type { CompositeSplitResult, ModelArg } from './types'
 ...
 *
 * @returns CompositeSplitResult if composite cedula detected, null otherwise
 */
export async function detectAndSplitCompositeCedulaV3(
  imageBuffer: Buffer,
  mimetype: string,
  model: ModelArg = 'gemini',
): Promise<CompositeSplitResult | null> {
